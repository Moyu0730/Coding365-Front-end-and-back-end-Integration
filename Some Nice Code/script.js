...
$(function () {
    ...
    $("#book_grid").kendoGrid({
        dataSource: {
            data: bookDataFromLocalStorage, /*Part2. TODO: 請改由remote datasource呼叫api取得資料來源 簡報某一頁*/ 
            // transport: {
            //     read: {
            //         url: "https://localhost:44314/api/bookmatain/loadbook",
            //         type: "post",
            //         dataType: "json"
            //     }
            // },
...
function updateBook(bookId){
    ...
    // var memberData = new kendo.data.DataSource({
    //     transport:{
    //         read:{
    ...
    $.ajax({
        type: "POST",
        url: "https:/localhost:44314/api/bookmatain/updatebook",
        dataType: "json",
        data: book,
        success: function(response){
            console.log(response);	
...
function registerRegularComponent(){
    ...
    dropDownList("#book_class_q","https://localhost:44314/api/code/bookclass")
    dropDownList("#book_class_d","https://localhost:44314/api/code/bookclass", onClassChange)
